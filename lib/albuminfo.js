 ...
 */
function makeAlbumInfo({ getLms, qobuzCall, qobuz, dataDir, normalize, artistKey, log, debug }) {
  ...
  async function qobuzAlbumReview({ title, artist, extid }) {
    ...
    } catch (e) { log.debug("qobuz review:", e.message); }
    return null;
  }
  ...
  async function qobuzArtistImage(name) {
    ...
    } catch (e) { log.debug("qobuz image:", e.message); }
    return null;
  }
  ...
  async function qobuzArtistBio(name) {
    ...
    } catch (e) { log.debug("qobuz bio:", e.message); }
    return null;
  }
