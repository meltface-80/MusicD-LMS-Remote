...
// MAIN set separates co-billed album artists (" / " is Roon's and LMS's
// joiner; "; " is the common file-tag multi-value form). " & " is
// intentionally NOT split — it is often part of a band name ("Simon &
// Garfunkel").
