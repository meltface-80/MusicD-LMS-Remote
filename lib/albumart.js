 ...
 *   4. iTunes Search API (artworkUrl100 upscaled to 600x600).
 *
...
function makeAlbumArt(opts) {
  ...
  // MusicBrainz etiquette (1 req/second, identified) comes from the SHARED gate
  // in lib/musicbrainz.js — see the note there.
